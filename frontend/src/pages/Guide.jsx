...
const DATA = {
  ...
  heart: {
    ...
    steps: [
      ...
      { title: 'اتصل بـ 1412 فوراً', desc: 'كل دقيقة مهمة. لا تنتظر تحسن الأعراض.' },
  ...
  cpr: {
    ...
    steps: [
      { title: 'تأكد من السلامة', desc: 'ناد المصاب بصوت عالٍ واهزّ كتفيه. إذا لم يستجب، اتصل بـ 1412.' },
  ...
  stroke: {
    ...
    steps: [
      ...
      { title: 'اتصل بـ 1412 فوراً', desc: 'السكتة طارئة قصوى. كل دقيقة تمر تضر بالمخ.' },
        ...
        <div style={styles.content}>
          ...
          <div style={styles.sosSection}>
            ...
            <a href="tel:1412" style={{ textDecoration: 'none' }}>
              <button style={styles.callBtn}>📞 1412 — الإسعاف</button>
            </a>
          </div>
        </div>
